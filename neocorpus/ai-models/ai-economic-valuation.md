...
The key data points as of early 2026: data center CapEx spending is at historic highs, ARK Invest's Chief Futurist Brett Winton calls the bubble narrative "flat wrong," and Anthropic's Economic Index introduces "economic primitives" (task complexity, autonomy, success rates) as a measurement framework for AI's economic impact by task category.
...
- **CapEx is justified**: Unlike the fiber optic boom, where supply was built speculatively, data center construction is responding to demonstrated demand. Inference volume is growing.
...
The prediction: productivity gains from AI tools will "triple over the course of this year and then triple again," leading to a compound increase in pricing power of 40 to 50 times. This is an extraordinary claim that, if correct, means current valuations are not inflated but deeply underpriced.

### 3. Economic Primitives and the Anthropic Economic Index

Anthropic's Economic Index introduces a framework for measuring AI's economic impact at the task level. Rather than asking "how much revenue does AI generate?" it introduces "economic primitives" — task complexity, autonomy levels, and success rates — as the units of measurement. The index shows uneven impact across task categories, with Claude excelling in high-skill tasks.

This task-primitive approach reveals that AI's impact is highly uneven by task category:
...
Winton's insight about pricing power is underappreciated. Current revenue projections for AI companies are "conservative relative to the pricing power that they have." As models become more capable, the gap between value delivered and price charged creates room for revenue expansion before customers defect.
...
| Frontier AI platform updates — mid-January 2026 | `corpus/ai-models/08814.md` | Anthropic Economic Index: "economic primitives" (task complexity, autonomy, success rates), uneven impact across task categories |
