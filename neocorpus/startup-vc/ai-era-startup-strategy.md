...
**The "AI company" as strategic category (now recognized as a non-category)**: From 2022-2024, "AI company" functioned as both an investment thesis and a competitive identity. Startups raised on the premise of being "AI-native" as if the technology itself was the strategy. This framing is now explicitly recognized in the corpus as a category error: AI is a delivery mechanism, not a strategic category. The strategic category is always the industry and the constraint within it. The "AI company" identity is the 2024 equivalent of the "internet company" identity in 1999 — a technological description mistaken for a strategic position (10970.md).

**The capability-adoption conflation (active failure mode)**: The dominant frame for enterprise AI from 2022-2024 treated frontier model performance curves as adoption curves — "GPT-4 can do X, therefore enterprises will use AI for X." This conflation produced systematic overestimation of near-term enterprise transformation. The TuringPost correction ("Something Medium Is Happening" — 10937.md) documents the gap between capability and deployment reality as structural, not transitional: procurement timelines, legal review, security clearances, compliance workflows, and organizational inertia decouple capability from adoption by 12-36 months regardless of model quality. Every enterprise AI product cycle that predicted rapid organizational change without modeling the institutional friction layer was operating from the prior conflated frame.

**Vertical integration as post-victory step (Teece supersession)**: The dominant startup strategy canon from the lean startup era treated vertical integration as a scaling decision — something you considered after achieving product-market fit and initial growth. David Teece's 1986 paper on profiting from technological innovation provides the historical correction that the Carnegie-Rockefeller evidence validates: integrating complementary assets is not a scaling decision, it is a simultaneous move made during the constraint attack. The innovator who waits for victory before integrating loses the value to faster integrators. The lean startup canon was optimized for a pre-AI environment where capital was scarce and quick validation was the binding constraint. In a winner-takes-more environment where the constraint-breaking moment is brief, Teece's timing is the operative lesson (10970.md).

**The "incremental positioning" trap as winner-takes-more casualty**: Pre-2020 startup strategy tolerated incremental positioning — "we're Salesforce but better for [vertical]" — because the market structure allowed smaller companies to occupy niches profitably. The winner-takes-more concentration documented in the corpus (41% of US VC to ten companies by mid-2025; top 10 unicorns at 52% of aggregate unicorn valuation) means the structural tolerance for incremental positioning has collapsed. Small castles with sound moats face existential pressure not from better competitors in their niche but from platform-layer displacement that makes the niche irrelevant. The corpus is explicit: in a winner-takes-more world, incremental positioning is not conservative — it is suicidal (10970.md).
