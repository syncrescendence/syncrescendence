...
BRIDGE_SCRIPTS = {
    "perplexity": "perplexity_response_bridge.py",
    "oracle": "oracle_response_bridge.py",
    "notebooklm": "notebooklm_response_bridge.py",
    "claude_cowork": "claude_cowork_response_bridge.py",
}
