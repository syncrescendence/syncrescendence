...
- **Evaluation Records** -- Skill evaluation reports should be persisted to `orchestration/state/evaluations/` for audit trail and quality trend tracking across the constellation's skill portfolio.
