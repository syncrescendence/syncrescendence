...
Follow the successor-shell work loop:

1. orient
2. objective lock
3. execute or delegate
4. emit receipts
5. update local and federal state
6. dispatch when office boundaries are crossed
7. compact before context decays
8. close with a lawful handoff, summary, or pattern promotion
